...
let initialState = () => {
  let sticker = mkSticker("Something", "data:image/gif;base64,");
  return {
    photo: null,
    picked: null,
    stuckers: [mkStucker(sticker, mkCoords(200, 250))],
    stickers: [
      sticker,
